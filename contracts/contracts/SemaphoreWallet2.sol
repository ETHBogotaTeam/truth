 ...
 */
contract SemaphoreWallet2 is BaseWallet , Verifier16 {
    ...
    function _validateSignature(
        ...
        // uint x = 10;
        (uint256[8] memory proof, uint256 groupRoot, uint256 nullifierHash, bytes32 signalBytes32, uint256 externalNullifier) = abi.decode(userOp.signature, (uint[8], uint256, uint256, bytes32, uint256));
        // const encodedProof = defaultAbiCoder.encode(['uint[8]', 'uint', 'uint', 'bytes32', 'uint'], [solidityProof,group.root,nullifierHash,signalBytes32,externalNullifier])

        uint256 signalHash = _hashSignal(signalBytes32);

        // verifyProof(
        //     [proof[0], proof[1]],
        //     [[proof[2], proof[3]], [proof[4], proof[5]]],
        //     [proof[6], proof[7]],
        //     [groupRoot, nullifierHash, signalHash, externalNullifier]
        // );
    }
